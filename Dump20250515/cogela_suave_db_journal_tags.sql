...
CREATE TABLE `journal_tags` (
  ...
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `journal_tags_ibfk_1` FOREIGN KEY (`journal_id`) REFERENCES `journal_entries` (`id`) ON DELETE CASCADE,
  CONSTRAINT `journal_tags_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`) ON DELETE CASCADE
